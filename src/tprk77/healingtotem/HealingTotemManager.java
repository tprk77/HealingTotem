...
public class HealingTotemManager {
	...
	public void addTotemType(TotemType totemtype){
	...
	public void removeTotemType(TotemType totemtype){
		this.totemtypes.remove(totemtype);
	}
	...
	private Totem yaml2totem(ConfigurationNode node){
		...
		return new Totem(totemtype, block);
	}
	...
	private TotemType yaml2totemtype(ConfigurationNode node){
		...
		return new TotemType(name, power, range, structuretype);
	}
}
